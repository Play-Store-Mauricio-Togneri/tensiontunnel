...
import com.mauriciotogneri.obstacles.activities.MainActivity;
...
public class Game
{
	...
	public Game(MainActivity mainActivity, LinearLayout blockScreen)
	{
		...
		blockScreen.setOnTouchListener(new OnTouchListener()
		{
			@Override
	...
	private void restart(boolean start)
	{
	...
	private void displayBlockScreen(final int score)
	{
		this.mainActivity.runOnUiThread(new Runnable()
		{
			...
			public void run()
			{
				TextView scoreView = (TextView)Game.this.blockScreen.findViewById(1);
