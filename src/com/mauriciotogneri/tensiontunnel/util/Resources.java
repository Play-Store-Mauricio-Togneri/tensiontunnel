...
public class Resources
{
	public static class Sounds
	{
		...
		public static final String POWER_UP_GOOD = Sounds.ROOT + "powerup_good.ogg";
		public static final String POWER_UP_BAD = Sounds.ROOT + "powerup_bad.ogg";
	}
	...
	public static class Sprites
	{
		...
		public static Shape[] BACKGROUND_GROUND_TOP;
		public static Shape[] BACKGROUND_GROUND_BOTTOM;
		...
		public static void initialize(Context context, float resolutionX, float resolutionY)
		{
			if (!Sprites.loaded)
			{
				...
				Sprites.BACKGROUND_GROUND_TOP = Sprites.loadSprite(context, R.raw.sprite_background_ground_top, resolutionX, resolutionY);
				Sprites.BACKGROUND_GROUND_BOTTOM = Sprites.loadSprite(context, R.raw.sprite_background_ground_bottom, resolutionX, resolutionY);
