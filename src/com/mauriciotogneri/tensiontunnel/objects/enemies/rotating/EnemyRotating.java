...
public class EnemyRotating
{
	...
	{
		this.x = x;
		this.y = Constants.Screen.RESOLUTION_Y / 2f;
		this.radius = Constants.Screen.RESOLUTION_Y / 4;
	...
	{
		return this.rectangle1.insideScreen(Constants.Screen.RESOLUTION_X) || this.rectangle2.insideScreen(Constants.Screen.RESOLUTION_X);
	}
